...
class DepositMoneySuccess extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                status == 'Success'
                    ? 'deposit.depositSuccess'.trns()
                    : 'deposit.depositPending'.trns(),
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      BuildRow(
                        title: "deposit.depositMoneySuccess.totalInvest".trns(),
              ...
              AppButton(
                text: "deposit.depositMoneySuccess.depositAgainButtonText"
                    .trns(),
                onPressed: () {
                  Get.offAllNamed(BaseRoute.deposit, arguments: true);
                },
                backgroundColor: AppColors.darkBackground,
              ),
              SizedBox(height: 20.h),
              AppButton(
                text: "deposit.depositMoneySuccess.gotoDashboardButton".trns(),
