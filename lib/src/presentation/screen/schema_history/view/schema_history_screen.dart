...
class SchemaHistoryScreen extends GetView<SchemaHistoryController> {
  const SchemaHistoryScreen({super.key});
                        ...
                        builder: (context, constraints) => ListView(
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Center(
                                child: Text(
                                  "schemaHistory.noCrowdSchemaHistory".trns(),
                                ),
                              ),
                            ),
                          ],
                      ...
                      children: [
                        Expanded(
                          child: ListView.builder(
                            ...
                            physics: const AlwaysScrollableScrollPhysics(),
                            itemCount: controller.invest.length,
                            padding: EdgeInsets.all(18.w),
                            itemBuilder: (BuildContext context, int index) {
                              final item = controller.invest[index];
